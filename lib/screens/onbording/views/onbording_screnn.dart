...
class _OnBordingScreenState extends State<OnBordingScreen> {
  ...
  final List<Onbord> _onbordData = [
    ...
    Onbord(
      ...
      description:
          "In particular, ecomprjlon can pack your orders, and help you seamlessly manage your shipments.",
    ),
    Onbord(
      ...
      title: "Nearby stores",
      description:
          "Easily track nearby ecomprjs, browse through their items and get information about their prodcuts.",
    ),
  ];
