...
import 'package:ecomprj/components/list_tile/divider_list_tile.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: ListView(
        children: [
          ProfileCard(
            name: user?.displayName ?? "User", // Display name or fallback
            email: user?.email ?? "No email", // Email or fallback
            imageSrc: '',
            press: () {
